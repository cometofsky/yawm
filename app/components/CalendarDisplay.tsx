...
export default function CalendarDisplay() {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto grid grid-cols-1 gap-6 mt-6 md:mt-12 px-2 sm:px-4">
      
      {/* --- MOBILE/TABLET COMPACT VIEW --- */}
      <div className="lg:hidden flex flex-col space-y-3 bg-white/5 border border-white/10 rounded-3xl p-5 md:p-6 backdrop-blur-md shadow-lg relative overflow-hidden">
      ...
      <div className="hidden lg:grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {/* English Card */}
        <div className="group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 backdrop-blur-md transition-all hover:bg-white/10 hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.2)]">
        ...
        {/* Hijri Card */}
        <div className="group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 backdrop-blur-md transition-all hover:bg-white/10 hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.2)]">
        ...
        {/* Bengali Card */}
        <div className="lg:col-span-2 xl:col-span-1 group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 backdrop-blur-md transition-all hover:bg-white/10 hover:shadow-[0_0_40px_-10px_rgba(245,158,11,0.2)]">
